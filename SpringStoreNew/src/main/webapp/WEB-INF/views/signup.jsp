...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="<c:url value="/WEB-INF/views/resources/registration.css"/>">
    <script type="text/javascript" src="<c:url value="/WEB-INF/views/resources/script.js"/>"></script>
