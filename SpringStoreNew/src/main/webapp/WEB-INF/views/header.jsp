...
<ul>
    <li><a class="active" href='<c:url value="/eshop"/>'><i class="fa fa-lg fa-fw fa-home"></i> Главная</a>
    </li>
    <%--    <li><a class="active" href='${contextPath}/home'><i class="fa fa-lg fa-fw fa-home"></i> Главная</a></li>--%>
    <li style="float:right"><a href='<c:url value="/logout"/>'><i class="fa fa-lg fa-fw fa-sign-in"></i>
        Завершить
        сеанс, ${userDto.getUsername()}</a></li>
    <li style="float:right"><a href='<c:url value="/cart"/>'><i
