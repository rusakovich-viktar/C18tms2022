...
<div class="row">
    <section class="section">
        ...
        <main>
            ...
            <form id="registrationForm" method="post" action="${basePath}/register" onsubmit="return validateForm()">
                ...
                <%--                    <option disabled selected>выбрать день</option>--%>
                ...
                <%--                    <option disabled selected>выбрать месяц</option>--%>
                ...
                <%--                    </c:forEach>--%>
                <%--                </select>--%>
                <%--                <select id="brthYears" name="brthYear" oninput="validateBrthday()" required>--%>
                <%--                    <option disabled selected>выбрать год</option>--%>
                ...
                <div class="form-item box-item">
                    ...
                    <%--                    <span id="usernameError" style="display: none;">*Поле 'Username' не заполнено!</span>--%>
                </div>
                <div class="form-item box-item">
